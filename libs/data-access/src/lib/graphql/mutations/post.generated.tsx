...
export type CreatePostMutation = { __typename?: 'Mutation', createPost: { __typename?: 'Post', _id: string, title: string, content: string, tagline: string, createdAt: string, updatedAt: string, slug?: string | null, coverPhotoURL?: string | null, publishedAt?: string | null, status: Types.Status, category: Types.Category, author: { __typename?: 'User', firstName: string, lastName: string, email: string, createdAt: string, updatedAt: string, profilePhotoURL: string } } };
...
export type RemovePostMutation = { __typename?: 'Mutation', removePost: { __typename?: 'Post', _id: string, title: string, content: string, tagline: string, createdAt: string, updatedAt: string, slug?: string | null, coverPhotoURL?: string | null, publishedAt?: string | null, status: Types.Status, category: Types.Category, author: { __typename?: 'User', firstName: string, lastName: string, email: string, createdAt: string, updatedAt: string, profilePhotoURL: string } } };
